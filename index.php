                     ...
                     <div class="carousel-inner">
                        <div class="carousel-item active">
                           <div class="banner_taital_main">
                              <h1 class="banner_taital">Vehicle Record <br><span style="color: #00008b;">For You</span></h1>
                           </div>
                        </div>
                     </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6"> 
                     <div class="about_taital_box">
                        ...
                        { 
                        ?>
                        <h1 class="about_taital">About <span style="color: #00008b;">Us</span></h1>
                        ...
                        <div class="select_box_main">
                           ...
                           <div class="row">
                              <div class="col-md-8 select-outline">
                                   <input type="text"  name="searchinputdata" class="form-control p-3" required="true" placeholder="Search By VehicleName, RegNum, Model Number">
                              </div>
                              <div class="col-md-4">
                                 <input type="Submit" name="Submit" id="Submit" class="btn btn-primary p-3 w-50" style = "background:#00008b;border:1px solid #fff;" value="Submit">
                              </div>
                           </div></form>
                        </div>
                     </div>
                  ...
                  <div class="col-md-120">
                     <div class="gallery_box">
                        ...
                        <h3 class="types_text"><?php echo htmlentities($result->VehicleName);?></h3>
                          ...
                          <p>
                           <font class = "mr-5">Vehicle licenses</font>
                           <font class="ml-5">Insurance</font>
                           </p>
                          <a href="images/<?php echo htmlentities($result->vehical_lecense);?>">
                           <img src="images/<?php echo htmlentities($result->vehical_lecense);?>" alt="<?php echo htmlentities($result->vehical_lecense);?>" class = "w-25">
                          </a>

                          <a href="images/<?php echo htmlentities($result->insurance);?>">
                           <img src="images/<?php echo htmlentities($result->insurance);?>" alt="<?php echo htmlentities($result->insurance);?>" class = "w-25">
                          </a>
